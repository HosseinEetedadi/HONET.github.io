...
class ServiceDataStorage:
    ...
    def _save_models(self):
        for node in self._nodes:
            ...
            if node.get_learning_type() == Node.LearningType.D_SARSA and (node.get_type() == Node.NodeType.SCHEDULER or node.get_type() == Node.NodeType.UP_SCHEDULER):
    ...
    def done_job(self, job: Job, reward: int):
        # noinspection SqlResolve
        # print(f"Final Result, Cluster id = {job.get_forwarded_to_cluster_id()}")
